...
<div class="input">
     <form action="Caredata">
                    <input name="Number" type="hidden" Value="8">
                    <input name="Type" type="hidden" Value="Fruits and insects">
