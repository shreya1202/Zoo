    ...
    <body>
        <%
            try {
                ...
                PreparedStatement pst = connection.prepareStatement("Select * from animals where Number=11");
                PreparedStatement ps = connection.prepareStatement("Select * from stock where Stock_type=?");
                ps.setString(1, "Mammals, birds and lizards");
        ...
        <div class="container" style=" background-image:url(<%=rs.getString("image")%>)">
            ...
            <div class="input">
                <form action="Caredata">
                    ...
                    <input name="Type" type="hidden" Value="Mammals, birds and lizards">
